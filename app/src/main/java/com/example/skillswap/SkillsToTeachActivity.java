...
public class SkillsToTeachActivity extends AppCompatActivity {
    ...
    private final ArrayList<String> teachableSkills = new ArrayList<>(Arrays.asList(
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        title.setText("What are you capable of?");
        ...
        submitButton.setOnClickListener(v -> {
            if (selectedSkills.size() == 0) {
                Toast.makeText(SkillsToTeachActivity.this, "Please select at least one skill", Toast.LENGTH_SHORT).show();
                return;
            }
            saveSkillsToDatabase("teach");
        });
    }
        ...
        button.setOnClickListener(v -> {
            ...
            if (selectedSkills.contains(skill)) {
                ...
                if (selectedSkills.size() < MAX_SKILL_SELECTION) {
                    ...
                    Toast.makeText(SkillsToTeachActivity.this, "You can select up to 5 skills only", Toast.LENGTH_SHORT).show();
                }
            }
        });
    ...
    private void saveSkillsToDatabase(String field) {
        Log.d("SkillsToTeachActivity", "saveSkillsToDatabase called");
        FirebaseUser currentUser = auth.getCurrentUser();
        if (currentUser == null) {
            Log.e("SkillsToTeachActivity", "No user logged in!");
        ...
        Log.d("SkillsToTeachActivity", "User ID: " + userId);
        ...
        db.collection("users").document(userId)
                ...
                .addOnSuccessListener(aVoid -> {
                    ...
                    Toast.makeText(SkillsToTeachActivity.this, "Skills saved successfully!", Toast.LENGTH_SHORT).show();
                    navigateToSkillsToLearn();
                })
    ...
    private void handleFailure(Exception e) {
        ...
        Toast.makeText(SkillsToTeachActivity.this, "Error: " + e.getMessage(), Toast.LENGTH_SHORT).show();
    }

    private void navigateToSkillsToLearn() {
        startActivity(new Intent(SkillsToTeachActivity.this, SkillsToLearnActivity.class));
